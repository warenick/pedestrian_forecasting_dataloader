...
dataloader = DataLoader(train_dataset, batch_size=1536,
                        shuffle=True, num_workers=6, pin_memory=True, collate_fn=collate_wrapper)
...
model_name="trajPred1_Noforces_bs1512"
writer, experiment_name, best_model_path, folder_path = setup_experiment(model_name, "../logs/"+model_name, "trajPred1_Noforces_bs1512")
